...
ROOT_URLCONF = 'free-meturist-back.urls'
...
WSGI_APPLICATION = 'free-meturist-back.wsgi.application'
...
# Email Config
EMAIL_SUBJECT_PREFIX = '[free-meturist-back] '
DEFAULT_FROM_EMAIL = 'No Reply <no-reply@free-meturist-back.com>'
SERVER_EMAIL = 'Server <server@free-meturist-back.com>'
# ADMINS = [('Admin', 'admin@free-meturist-back.com')]
# MANAGERS = [('Admin', 'admin@free-meturist-back.com')]
