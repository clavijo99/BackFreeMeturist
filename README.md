...
```
git clone https://github.com/altixco/django-postgres-dokku free-meturist-back
cd free-meturist-back
```
...
```
make name=free-meturist-back init
```
...
```
dokku apps:create free-meturist-back
dokku postgres:create free-meturist-back
dokku postgres:link free-meturist-back free-meturist-back
```
...
```
dokku config:set free-meturist-back ENVIRONMENT=production DJANGO_SECRET_KEY=....
```
